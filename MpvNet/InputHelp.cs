...
public static class InputHelp
{
    public static List<Binding> GetDefaults()
    {
        ...
        Add(b, new(_("Subtitle"), _("Move Left"), "add sub-margin-x -100", "i"));
        //Add(b, new(_("Subtitle"), _("Move Right"), "add sub-margin-x 10", "I"));
        Add(b, new(_("Subtitle"), _("Move Left"), "add sub-align-x 200", "I"));
        Add(b, new (_("Subtitle"), "-"));
        ...
        //Add(b, new("Video", "3Dmode", "Switch3DMode"));
